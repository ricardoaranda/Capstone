...
public:
                           ...
                           float rotaryEndAngle, Slider &slider) override
    {
        ...
        /********************** BACKGROUND **********************/
        ColourGradient gradientBackground {Colour (170 + (sliderPosProportional * 18), 170 - (sliderPosProportional * 118), 170 - (sliderPosProportional * 118)),
        ...
        // outter reflection
        g.setGradientFill ({Colour (170 + (sliderPosProportional * 67), 170 - (sliderPosProportional * 80), 170 - (sliderPosProportional * 80)),
        ...
        // dial
        g.setGradientFill ({Colour (96, 96 - (sliderPosProportional * 10), 96 - (sliderPosProportional * 10)),
            gradientX, gradientY, Colours::black, gradientX2, gradientY2, false});
        g.fillEllipse (innerBounds);
