...
public:
                           ...
                           float rotaryEndAngle, Slider &slider) override
    {
        ...
        /********************** BACKGROUND **********************/
        ColourGradient gradientBackground {Colour (144 + (sliderPosProportional * 108), 144 + (sliderPosProportional * 11), 114 - (sliderPosProportional * 56)),
        ...
        // outter reflection
        g.setGradientFill ({Colour (234 + (sliderPosProportional * 21), 234 - (sliderPosProportional * 54), 234 - (sliderPosProportional * 134)),
        ...
        // reflection
        g.setGradientFill ({Colour (170 + (sliderPosProportional * 85), 170 + (sliderPosProportional * 8), 170 - (sliderPosProportional * 70)),
