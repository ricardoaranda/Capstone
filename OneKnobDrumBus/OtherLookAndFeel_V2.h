...
public:
                           ...
                           float rotaryEndAngle, Slider &slider) override
    {
        ...
        /********************** BACKGROUND **********************/
        ColourGradient gradientBackground {Colour (144 + (sliderPosProportional * 40), 144 - (sliderPosProportional * 22), 114 + (sliderPosProportional * 100)),
        ...
        // outter reflection
        g.setGradientFill ({Colour (234 - (sliderPosProportional * 34), 234 - (sliderPosProportional * 74), 234 - (sliderPosProportional * 14)),
        ...
        // reflection
        g.setGradientFill ({Colour (170 + (sliderPosProportional * 25), 170, 170 + (sliderPosProportional * 30)),
