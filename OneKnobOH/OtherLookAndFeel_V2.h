...
public:
                           ...
                           float rotaryEndAngle, Slider &slider) override
    {
        ...
        /********************** BACKGROUND **********************/
        ColourGradient gradientBackground {Colour (144 + (sliderPosProportional * 30), 144 + (sliderPosProportional * 90), 114 + (sliderPosProportional * 111)),
        ...
        // outter reflection
        g.setGradientFill ({Colour (234 - (sliderPosProportional * 19), 234 + (sliderPosProportional * 11), 234 + (sliderPosProportional * 21)),
            gradientX, gradientY, Colour (0, 0, 0), gradientX2 - 190, gradientY2 - 86, false});
        ...
        if (slider.isEnabled())
        {
            ...
            g.setColour (Colour (100, 215, 255));
        ...
        // dial
        g.setGradientFill ({Colour (81, 81, 81), gradientX, gradientY, Colours::black, gradientX2, gradientY2, false});
        g.fillEllipse (innerBounds);
        ...
        // reflection
        g.setGradientFill ({Colour (170 - (sliderPosProportional * 30), 170 + (sliderPosProportional * 30), 170 + (sliderPosProportional * 45)),
                            gradientX, gradientY, Colour (0, 0, 0), gradientX2 - 40, gradientY2 - 40, false});
